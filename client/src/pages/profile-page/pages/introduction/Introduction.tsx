  ...
  return(
    <StyledIntroduction>
      ...
      <Text style={{fontSize: "2em", textAlign: "center", margin: "20px 0"}}>
        ...
        Полный доступ доступен только с флагом "User", который вы можете попросить у создателя сайта. Также, сайт является демонстрацией навыков, что-то напоминающее портфолио.
      </Text>
      <Text style={{fontSize: "2em", textAlign: "center", margin: "20px 0"}}>
